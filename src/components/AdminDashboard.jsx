...
const AdminDashboard = () => {
  ...
  const exportToExcel = () => {
    ...
    XLSX.writeFile(workbook, "tulsi_arena_bookings.xlsx");
  };
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex gap-4 mb-6">
          <button
            ...
            className={`px-6 py-3 rounded-xl font-semibold transition ${activeTab === 'overview'
          ...
          <button
            ...
            className={`px-6 py-3 rounded-xl font-semibold transition ${activeTab === 'bookings'
                ? 'bg-blue-600 text-white'
                : 'bg-slate-800/40 text-blue-200 hover:bg-slate-800/60'
              }`}
          >
          ...
          <button
            ...
            className={`px-6 py-3 rounded-xl font-semibold transition ${activeTab === 'facilities'
                ? 'bg-blue-600 text-white'
                : 'bg-slate-800/40 text-blue-200 hover:bg-slate-800/60'
              }`}
          >
          ...
          <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-blue-500/20">
            ...
            <div className="flex justify-end mb-4">
              <button
                ...
                className="px-5 py-2 bg-green-600 hover:bg-green-700 text-white rounded-xl shadow-lg"
              >
                📥 Export to Excel
              </button>
            </div>
