...
const Dashboard = () => {
  ...
  const turfs = [
    ...
    { id: 3, name: 'Swimming Pool', type: 'pool', price: 100, capacity: 20, image: 'https://images.unsplash.com/photo-1576610616656-d3aa5d1f4534?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8c3dpbW1pbmclMjBwb29sfGVufDB8fDB8fHww', available: true }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 pb-20">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {turfs.map((turf) => (
                  <div
                    key={turf.id}
                    className="bg-slate-800/40 backdrop-blur-md rounded-2xl shadow-xl border border-blue-500/20 hover:border-blue-500/40 transition-all hover:-translate-y-1 flex flex-col"
                  >
                    {/* Image Section */}
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      <h4 className="text-xl font-bold text-white mb-4 text-center">{turf.name}</h4>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-around py-3">
            <button
              ...
              className={`flex flex-col items-center p-2 rounded-lg transition ${activeTab === 'home' ? 'text-blue-400' : 'text-slate-400 hover:text-blue-300'
                }`}
            >
              <Home size={24} />
            ...
            <button
              ...
              className={`flex flex-col items-center p-2 rounded-lg transition ${activeTab === 'bookings' ? 'text-blue-400' : 'text-slate-400 hover:text-blue-300'
                }`}
            >
              <BookOpen size={24} />
            ...
            <button
              ...
              className={`flex flex-col items-center p-2 rounded-lg transition ${activeTab === 'profile' ? 'text-blue-400' : 'text-slate-400 hover:text-blue-300'
                }`}
            >
              <User size={24} />
      ...
      {/* Booking Form Modal */}
      {selectedFacility && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm transition-opacity duration-300 overflow-y-auto" onClick={closeBookingModal}>
          {/* Modal Content container - stops propagation so clicking inside doesn't close it */}
          <div
